...
Nine SVG paths (Claude, Google Gemini, Docker, Kubernetes, PostgreSQL, Python,
Node.js, Git, Terraform) are copied from [Simple Icons](https://simpleicons.org),
whose icon files are released under [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/).

They are copied rather than depended on because jterm needs nine glyphs out of
